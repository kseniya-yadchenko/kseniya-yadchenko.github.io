...
- [ ] **T5.3** Контраст текста ниже WCAG AA — унаследовано из палитры макета
  ...
  - Первые две правки визуально неразличимы. Третья заметно темнее и меняет
    воздушность макета — это уже решение дизайна, а не механическая починка,
    поэтому вынесено в вопрос, а не сделано молча (см. границы в SPEC.md).
